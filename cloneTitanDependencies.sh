...
if [ -d "$PATH_CORE" ]; then
  ...
  git clone https://github.com/eclipse/titan.core.git $PATH_CORE
fi
...
ln -s ${PATH_MQTT}/src/negative_testing/Mqtt_v3.1.1_Types.ttcn
ln -s ${PATH_MQTT}/src/negative_testing/Mqtt_v3_1_1_IPL4SizeFunction.ttcn
ln -s ${PATH_MQTT}/src/negative_testing/Mqtt_v3.1.1_EncDec.cc
ln -s ${PATH_MQTT}/src/negative_testing/Mqtt_v3.1.1_Size.cc
