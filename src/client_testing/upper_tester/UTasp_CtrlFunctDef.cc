...
//  the UTasp__PortType tag with the module name in which the
...
#include "UTasp_PortType.hh"
#include "IPL4asp_PT.hh"



namespace UTasp__CtrlFunct {

  IPL4asp__Types::Result f__UT__IPL4__listen(

    UTasp__PortType::UTasp__PT& portRef,
  ...
  IPL4asp__Types::Result f__UT__IPL4__connect(
  ...
  IPL4asp__Types::Result f__UT__IPL4__close(
  ...
  IPL4asp__Types::Result f__UT__IPL4__setUserData(
  ...
  IPL4asp__Types::Result f__UT__IPL4__getUserData(
  ...
  void f__UT__IPL4__setGetMsgLen(
